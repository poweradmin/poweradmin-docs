...
Download the latest release from the [stable line](https://github.com/poweradmin/poweradmin/releases) (currently the 4.3.x series). Always check the releases page for the most recent version - the example below uses v4.3.5:
