...
4. **From v3.9.x**: You're on the right page - follow the [Upgrade Instructions](#upgrade-instructions) above
...
- **Advanced Workflow Configuration**
    - **Edit Conflict Resolution**: Two strategies for handling concurrent edits:
...
- Legacy configuration format (`inc/config.inc.php`) is supported in v4.0.0 but **was completely removed in 4.1.0**, along with the migration script
