...
- **display_signed_serial_in_zone_list**: Show the serial as served by PowerDNS with SOA-EDIT applied (the "signed" serial) in zone lists. Requires the API backend (`dns.backend = 'api'`) and PowerDNS 4.3+ (v4.5.0+). Default: `false`
