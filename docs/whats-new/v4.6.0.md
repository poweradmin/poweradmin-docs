...
Zone deletion can be requested the same way. `approval.require_review_for_all` sends every
change through review, editors and administrators included.
...
reviewers and requesters is a separate switch, `notifications.change_request_enabled`. The
