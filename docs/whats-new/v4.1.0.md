...
`/zones/forward` and `/users/5/edit`, across more than a hundred named routes.
...
| Performance indexes | Ten indexes across the log, user, permission and template tables | [Database Schema](../database/schema.md) |
...
| v4.1.2 | `PA_LOGGING_*` environment variables |
