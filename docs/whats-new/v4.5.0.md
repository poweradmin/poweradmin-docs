...
| Consumer zone creation | Creating a catalog Consumer now asks for the primary it transfers from, and stops seeding the zone with an SOA and template records it should not have. Assigning members to a catalog is still not supported | [Zone Management](../user-guide/zones.md) |
