...
Eleven new permissions break apart rights that previously required superuser. And API v1,
...
Administrators can set a default TTL for each record type from **Tools → TTL defaults**.
